...
const ADULT_GAMES = [
  ...
  },
  {
    ...
    description: "Name a biblical figure who fits both attributes in the grid — coming soon.",
    badge: "Coming Soon",
...
const KIDS_GAMES = [
  ...
  },
  {
    ...
    emoji: "✏️",
    title: "Bible Fill-In",
    description: "Complete famous Bible stories with the missing word — coming soon.",
    badge: "Coming Soon",
    badgeColor: "bg-muted text-muted-foreground",
    age: "6–12",
    disabled: true,
